...
export default function JourneyPage() {
  ...
  return (
    <main className="bg-black text-white min-h-screen">
      ...
      <div className="max-w-4xl mx-auto pt-32 px-4 sm:px-6 pb-16 sm:pb-24">
        <h1 className="text-2xl sm:text-5xl font-extrabold mb-4 sm:mb-16 text-center bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text drop-shadow-lg tracking-tight font-[Poppins,Inter,sans-serif]">
          My Journey
        </h1>

...
export default function ProjectPage() {
  ...
  return (
    <main className="relative z-10 min-h-screen bg-black text-white">
      ...
      {/* Main Content */}
      <div className="max-w-6xl mx-auto pt-32 px-6 mb-16">
        <h1 className="text-4xl sm:text-5xl font-bold mb-12 bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text">
          Projects 
        </h1>
        <div className="flex flex-col gap-10">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="w-full flex flex-col md:flex-row items-stretch bg-black rounded-2xl shadow-lg hover:shadow-blue-500/20 transition-all duration-300 p-0 overflow-hidden min-h-[220px]"
            >
              {/* Project Image Placeholder (replace with project.image if available) */}
              <div className="flex-shrink-0 w-full md:w-2/5 h-56 md:h-auto bg-gray-900 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="flex-1 flex flex-col justify-center p-8">
                <h2 className="text-2xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-white text-transparent bg-clip-text">
                  {project.title}
                </h2>
                ...
                <a
                  ...
                  className="inline-block text-base font-medium text-blue-500 hover:underline bg-gray-900/60 rounded px-5 py-2 mt-2 md:self-start whitespace-nowrap"
                >
                  View Project →
                </a>
              </div>

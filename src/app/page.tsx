  ...
  return (
    <main className="relative min-h-screen text-white">
      ...
      <motion.section
        ...
        id="home"
        className="pt-20 sm:pt-32 pb-8 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between min-h-[calc(100vh-6rem)] text-left max-w-6xl mx-auto"
      >
        {/* Left: Avatar and Intro */}
        <div className="flex-1 flex flex-col items-start justify-center w-full min-w-0">
          {/* Responsive Video */}
          <div className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl overflow-hidden rounded-xl mb-4">
            <video
              id="waveVideo"
              src="/video.mp4"
              muted
...
">
          ...
          <div className="flex flex-col space-y-4 sm:space-y-6 w-full max-w-2xl">
            ...
            <div className="text-base sm:text-lg text-gray-400 w-full min-h-[3.5rem] px-2 sm:px-4 md:px-8 text-left">
      ...
      >
        <div className="max-w-6xl mx-auto px-2 sm:px-6">
          <h2 className="text-xl sm:text-3xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text text-left">
            Tools I Use
          </h2>
          <p className="text-gray-400 mb-6 sm:mb-12 max-w-2xl text-left text-base sm:text-lg">
            Here&apos;s a list of technologies, tools, and frameworks I&apos;ve worked with across different domains.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 items-stretch max-w-6xl mx-auto">
          {[
            {
              title: "Frontend",
              tools: [
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.h2 variants={itemVariants} className="text-xl sm:text-3xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text text-left">
            Featured Projects
          </motion.h2>
          <motion.p variants={itemVariants} className="text-gray-400 mb-6 sm:mb-12 max-w-2xl text-left text-base sm:text-lg">
          ...
          <div className="flex justify-end items-center pt-4 sm:pt-9">
            <Link
              href="/project"
      ...
      <motion.section
        ...
        style={{ perspective: 1000 }}
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 sm:pb-32">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text text-left">
            Connect With Me
          </h2>
          <p className="text-gray-400 text-base sm:text-lg mb-8 max-w-2xl text-left">
      ...
      <footer className="bg-black/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-6">
          <div className="flex items-center gap-2">
            <span className="text-gray-400 text-xs sm:text-base">© {year ?? ''} Prince. All rights reserved.</span>
          </div>

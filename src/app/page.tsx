  ...
  return (
    <main className="relative z-10 min-h-screen bg-black text-white">
      ...
      <motion.section
        ...
        id="home"
        className="pt-32 px-6 flex flex-col md:flex-row items-center justify-between min-h-[calc(100vh-6rem)] text-left max-w-6xl mx-auto"
      >
        {/* Left: Avatar and Intro */}
        <div className="flex-1 flex flex-col items-start justify-center">
          {/* Avatar */}
          <div className="mb-8 w-40 h-40 rounded-full overflow-hidden border-4 border-blue-500 shadow-[0_0_40px_#3b82f6]">
            <img
              src="/Mr3W.gif"
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 leading-tight bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text">
            Hey, I'm <span className="text-blue-300">Prince </span>
          </h1>
          <h2 className="text-4xl sm:text-4xl font-bold  mb-9 text-white-200">
             Developer 
          </h2>
          <div className="flex flex-col space-y-8 w-full max-w-6xl">
            {/* Typewriter About Intro */}
            <p className="text-lg text-gray-400 w-full max-w-6xl min-h-[3.5rem] px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 text-left">
              {typedAbout}
      ...
      >
        ...
        >
          <motion.h2
            ...
            className="text-3xl sm:text-5xl inline-block w-full font-bold mb-4  bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text"
          >
            Tools I Use
          </motion.h2>
          <motion.p
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.h2 variants={itemVariants} className="text-3xl sm:text-5xl inline-block w-full font-bold mb-4 bg-gradient-to-r from-blue-400 via-blue-200 to-white text-transparent bg-clip-text">
            Featured Projects
          </motion.h2>
          <motion.p variants={itemVariants} className="text-gray-400 mb-12 max-w-2xl">
          ...
          <div className="flex justify-end items-center pt-9">
            <a
              href="/project"
              className="bg-gradient-to-r from-blue-500 to-white hover:from-blue-600 hover:to-white text-blue-900 font-semibold py-3 px-8 rounded-lg shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
            >
              View My Work
            </a>
          </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-24 flex flex-col md:flex-row gap-12">
          {/* Left side - Text */}

...
export const BackgroundBeamsWithCollision = ({
  ...
  console.log("BackgroundBeamsWithCollision rendering");
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-screen bg-gradient-to-b from-black to-neutral-900 relative w-full overflow-hidden",
        className
      )}
    >
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-blue-400 via-cyan-400 to-transparent shadow-sm shadow-blue-400/50",
